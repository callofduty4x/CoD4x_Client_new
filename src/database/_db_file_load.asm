;Imports of db_file_load:
	...
	extern iCloseHandle
	extern _Z23DB_AuthLoad_InflateInitP10z_stream_sbPKc
	...
	extern _Z21DB_FileReadCompletionmmP11_OVERLAPPED
...
;DB_ResetZoneSize(bool)
_Z16DB_ResetZoneSizeb:
	push ebp
	mov ebp, esp
...
_Z20DB_LoadXFileInternalv_60:
	...
	mov [esp+0x4], eax
	mov dword [esp], g_load+0x24
	call _Z23DB_AuthLoad_InflateInitP10z_stream_sbPKc
	xor esi, esi
	test bl, bl
