...
_Z9Q_strncatPciPKc:
	...
	lea ebx, [ecx-0x1]
	cmp ebx, esi
	jl _Z9Q_strncatPciPKc_10
	mov dword [esp+0x4], _cstring_i_strncat_alread
	mov dword [esp], 0x1
	call _Z9Com_Error11errorParm_tPKcz
_Z9Q_strncatPciPKc_10:
	sub esi, ebx
	add ebx, [ebp+0x8]
	lea eax, [esi-0x1]
	mov [esp+0x8], eax
...
_cstring_i_strncat_alread:		db 015h,"Q_strncat: already overflowed",0
