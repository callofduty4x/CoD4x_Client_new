;Imports of ui_expressions:
	...
	extern _Z14LocalizeStringP11OperandListP7Operand

;Exports of ui_expressions:
	global g_releaseBuildStatement
	global s_operatorPrecedence
	global s_tempOperandValueAsString ;static for parse_expression
	global currentTempOperand ;static for parse_expression
