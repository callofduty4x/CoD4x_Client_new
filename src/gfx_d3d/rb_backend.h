...
extern unsigned int (*rb_tessTable[13])(GfxDrawSurfListArgs *, GfxCmdBufContext);
...
typedef void (*DrawCallCallback)(const void *, GfxCmdBufContext, GfxCmdBufContext);
...
void RB_Draw3DInternal(GfxViewInfo const*);
...
void RB_DrawShadowCookies(const GfxViewInfo *viewInfo);
