;Imports of scr_compiler:
	...
	extern gScrVarPub
	extern memcpy
	extern _Z27Hunk_AllocateTempMemoryHighi
	...
	extern _Z15TempMallocAligniStrict
	...
	extern gScrCompileGlob
	extern gScrCompilePub


;Exports of scr_compiler:
;	global gScrCompileGlob
	global _Z10LinkThreadjP13VariableValueb
	...
	global _Z21Scr_FindLocalVarIndexj6sval_ubP11scr_block_s
	...
	global _Z13EmitStatement6sval_ubjP11scr_block_s
...
_Z10LinkThreadjP13VariableValueb:
	push ebp
	mov ebp, esp
	push edi
	push esi
...
Scr_CalcLocalVarsStatement_2160:
	mov ecx, [gScrCompileGlob+0x3c]
	mov [ebp-0x144], ecx
	mov esi, [gScrCompileGlob+0x40]
	mov [ebp-0x140], esi
	mov eax, [gScrCompileGlob+0x48]
	mov [ebp-0x13c], eax
	mov edx, [gScrCompileGlob+0x4c]
	mov [ebp-0x138], edx
	mov dword [ebp-0x1c], 0x0
	mov dword [ebp-0x20], 0x0
	mov dword [esp], 0x1000
	call _Z27Hunk_AllocateTempMemoryHighi
	mov esi, eax
	mov [gScrCompileGlob+0x48], eax
	lea eax, [ebp-0x20]
	mov [gScrCompileGlob+0x4c], eax
	cmp byte [ebp-0x145], 0x0
	jnz Scr_CalcLocalVarsStatement_300
	mov dword [ebp-0x130], 0x0
Scr_CalcLocalVarsStatement_2090:
	mov ecx, [ebp-0x130]
	mov [gScrCompileGlob+0x3c], ecx
	mov eax, [ebp-0x14c]
	mov edx, [eax]
	test edx, edx
...
Scr_CalcLocalVarsStatement_2130:
	mov eax, [gScrCompileGlob+0x3c]
	mov [ebp-0x110], eax
	mov edx, [gScrCompileGlob+0x40]
	mov [ebp-0x10c], edx
	mov ecx, [gScrCompileGlob+0x48]
	mov [ebp-0x108], ecx
	mov esi, [gScrCompileGlob+0x4c]
	mov [ebp-0x104], esi
	mov dword [ebp-0x1c], 0x0
	mov dword [ebp-0x20], 0x0
	mov dword [esp], 0x1000
...
Scr_CalcLocalVarsStatement_2750:
	mov edi, [ebx+0x8]
	mov esi, [gScrCompileGlob+0x3c]
	mov [ebp-0xd0], esi
	mov eax, [gScrCompileGlob+0x40]
	mov [ebp-0xcc], eax
	mov dword [ebp-0x1c], 0x0
	mov dword [esp], 0x1000
	call _Z27Hunk_AllocateTempMemoryHighi
...
Scr_CalcLocalVarsStatement_1260:
	...
	mov [gScrCompileGlob+0x3c], eax
	mov edx, [ebp-0x140]
	mov [gScrCompileGlob+0x40], edx
	mov ecx, [ebp-0x13c]
	mov [gScrCompileGlob+0x48], ecx
	mov esi, [ebp-0x138]
	mov [gScrCompileGlob+0x4c], esi
	jmp Scr_CalcLocalVarsStatement_10
Scr_CalcLocalVarsStatement_740:
	mov edx, [ebp-0xd0]
	mov [gScrCompileGlob+0x3c], edx
	mov ecx, [ebp-0xcc]
	mov [gScrCompileGlob+0x40], ecx
	jmp Scr_CalcLocalVarsStatement_10
...
EmitValue_50:
	...
	mov [gScrCompileGlob], eax
	mov [eax], bx
	cmp dword [gScrCompilePub+0x20024], 0x2
	jz EmitValue_20
	cmp byte [gScrCompileGlob+0x1c], 0x0
	jnz EmitValue_30
EmitValue_60:
	mov dword [esp+0x4], 0x1
	mov [esp], ebx
...
EmitValue_110:
	...
	call _Z12AddOpcodePosji
	mov dword [esp], 0x4
	call _Z15TempMallocAligniStrict
	mov [gScrCompileGlob], eax
	mov [eax], ebx
	jmp EmitValue_10
EmitValue_100:
...
EmitOpcode_40:
	...
	mov ecx, [ebp-0x20]
	lea edx, [eax+ecx]
	mov [gScrCompileGlob+0x10], edx
	cmp edx, [gScrCompileGlob+0x14]
	mov eax, [gScrCompileGlob+0x14]
	cmovg eax, edx
	mov [gScrCompileGlob+0x14], eax
	mov ecx, [ebp-0x24]
	test ecx, ecx
	jz EmitOpcode_50
	cmp [gScrCompileGlob+0x18], edx
	mov eax, [gScrCompileGlob+0x18]
	cmovl eax, edx
	mov [gScrCompileGlob+0x18], eax
EmitOpcode_50:
	mov ecx, gScrVarPub
	mov edx, [ecx+0x38]
	mov eax, edx
	...
	test edx, edx
	jz EmitOpcode_60
	mov [gScrCompileGlob], edx
	mov eax, [ebp-0x1c]
	sub eax, 0x20
	cmp eax, 0x3e
	jbe EmitOpcode_70
EmitOpcode_60:
	mov [gScrCompileGlob+0x4], edx
	mov dword [esp], 0x1
...
EmitOpcode_280:
	...
	lea eax, [edx-0x1]
	mov [gScrCompilePub+0x20028], eax
	mov dword [gScrCompileGlob+0x4], 0x0
	mov [gScrCompileGlob], eax
...
_Z21Scr_FindLocalVarIndexj6sval_ubP11scr_block_s:
	push ebp
	mov ebp, esp
	push edi
	push esi
...
Scr_FindLocalVarIndex_30:
	...
	mov eax, [edi+0x18]
	mov [ebp-0x1c], eax
	movzx edx, byte [gScrCompileGlob+0x1c]
	mov [ebp-0x1d], dl
	mov byte [gScrCompileGlob+0x1c], 0x1
	mov dword [esp], 0x2
	call _Z15TempMallocAligni
	mov [gScrCompileGlob], eax
	cmp dword [gScrCompilePub+0x20024], 0x2
...
Scr_FindLocalVarIndex_20:
	...
	cmp byte [gScrCompileGlob+0x50], 0x0
...
_Z21EmitContinueStatement6sval_uP11scr_block_s:
	...
	mov esi, eax
	mov ebx, edx
	cmp byte [gScrCompileGlob+0x34], 0x0
...
EmitContinueStatement_60:
	...
	call _Z27Hunk_AllocateTempMemoryHighi
	mov ebx, eax
	mov eax, [gScrCompileGlob]
	mov [ebx], eax
	mov dword [esp], 0x0
	call _Z10TempMalloci
	mov [ebx+0x4], eax
	mov eax, [gScrCompileGlob+0x38]
	mov [ebx+0x8], eax
	mov [gScrCompileGlob+0x38], ebx
	add esp, 0x1c
	pop ebx
	pop esi
	pop edi
...
_Z18EmitBreakStatement6sval_uP11scr_block_s:
	...
	mov esi, eax
	mov ebx, edx
	cmp byte [gScrCompileGlob+0x2c], 0x0
...
EmitBreakStatement_60:
	...
	call _Z10TempMalloci
	mov [ebx+0x4], eax
	mov eax, [gScrCompileGlob+0x30]
	mov [ebx+0x8], eax
	mov [gScrCompileGlob+0x30], ebx
	add esp, 0x1c
	pop ebx
	pop esi
	pop edi
...
EmitFunction_180:
	...
	add dword [gScrCompileGlob+0x54], 0x8
	mov [esp+0x4], esi
...
EmitOrEvalPrimitiveExpression_100:
	...
	mov [gScrCompilePub], eax
	lea eax, [eax+eax*2]
	lea ecx, [eax*4+gScrCompileGlob+0x58]
	xor edi, edi
	lea ebx, [ebp-0x30]
...
EmitVariableExpression_50:
	...
	mov edx, eax
	mov eax, ebx
	call _Z21Scr_FindLocalVarIndexj6sval_ubP11scr_block_s
	mov esi, eax
	cmp eax, 0x5
...
_Z13EmitStatement6sval_ubjP11scr_block_s:
EmitStatement_200:
	push ebp
	mov ebp, esp
	push edi
...
EmitStatement_770:
	mov esi, [ebx+0x8]
	mov edi, [ebx+0x4]
	mov byte [gScrCompileGlob+0x50], 0x1
	mov edx, [ebp+0x8]
	mov eax, edi
	call EmitVariableExpressionRef
	mov byte [gScrCompileGlob+0x50], 0x0
	xor ecx, ecx
	mov edx, 0x1
	mov eax, 0x64
	call _Z10EmitOpcodejii
...
EmitStatement_790:
	...
	mov eax, edi
	call _Z22EmitVariableExpression6sval_uP11scr_block_s
	mov byte [gScrCompileGlob+0x1c], 0x0
	lea ebx, [ebp-0x24]
	mov ecx, [ebp+0x8]
	mov edx, ebx
	mov eax, [ebp-0x3c]
...
EmitIfElseStatement_30:
	...
	mov ecx, [ebp+0x14]
	mov eax, [ebp-0x80]
	call _Z13EmitStatement6sval_ubjP11scr_block_s
	mov eax, [ebp+0x1c]
	mov ebx, [eax]
	mov eax, [ebx]
	test eax, eax
...
_Z18EmitWhileStatement6sval_uS_S_S_P11scr_block_sPS_:
	...
	mov [ebp-0x84], edx
	mov [ebp-0x88], ecx
	movzx eax, byte [gScrCompileGlob+0x2c]
	mov [ebp-0x71], al
	mov edx, [gScrCompileGlob+0x30]
	mov [ebp-0x70], edx
	mov byte [gScrCompileGlob+0x2c], 0x0
	movzx ecx, byte [gScrCompileGlob+0x34]
	mov [ebp-0x69], cl
	mov ebx, [gScrCompileGlob+0x38]
	mov [ebp-0x68], ebx
	mov byte [gScrCompileGlob+0x34], 0x0
	mov esi, [ebp+0x10]
	mov edi, [esi]
	mov [ebp-0x30], edi
	mov eax, [ebp+0xc]
...
EmitWhileStatement_420:
	mov edx, [gScrCompileGlob+0x3c]
	mov [ebp-0x64], edx
	mov ecx, [gScrCompileGlob+0x40]
	mov [ebp-0x60], ecx
	mov ebx, [gScrCompileGlob+0x44]
	mov [ebp-0x50], ebx
	mov esi, [gScrCompileGlob+0x48]
	mov [ebp-0x58], esi
	mov eax, [gScrCompileGlob+0x4c]
	mov [ebp-0x54], eax
	mov dword [ebp-0x1c], 0x0
	mov dword [gScrCompileGlob+0x48], 0x0
	mov edx, [ebp+0x10]
	mov eax, [edx]
	mov [gScrCompileGlob+0x44], eax
	mov ecx, edi
	test cl, cl
...
EmitWhileStatement_340:
	mov eax, [ebp-0x5c]
	mov [gScrCompileGlob+0x3c], eax
	mov byte [gScrCompileGlob+0x2c], 0x1
	mov dword [gScrCompileGlob+0x30], 0x0
	mov byte [gScrCompileGlob+0x34], 0x1
	mov dword [gScrCompileGlob+0x38], 0x0
	mov edx, [ebp+0x10]
	mov eax, [edx]
	mov [esp], eax
	xor ecx, ecx
...
EmitWhileStatement_250:
	...
	mov [gScrCompileGlob+0x2c], al
	mov edx, [ebp-0x70]
	mov [gScrCompileGlob+0x30], edx
	movzx ecx, byte [ebp-0x69]
	mov [gScrCompileGlob+0x34], cl
	mov ebx, [ebp-0x68]
	mov [gScrCompileGlob+0x38], ebx
	mov eax, edi
	test al, al
...
EmitWhileStatement_270:
	...
	mov [gScrCompileGlob+0x3c], ecx
	mov ebx, [ebp-0x60]
	mov [gScrCompileGlob+0x40], ebx
	mov esi, [ebp-0x50]
	mov [gScrCompileGlob+0x44], esi
	mov eax, [ebp-0x58]
	mov [gScrCompileGlob+0x48], eax
	mov edx, [ebp-0x54]
	mov [gScrCompileGlob+0x4c], edx
	add esp, 0xac
	pop ebx
	pop esi
	pop edi
...
_Z16EmitForStatement6sval_uS_S_S_S_S_P11scr_block_sPS_S2_:
	...
	mov [ebp-0xb8], edx
	mov [ebp-0xbc], ecx
	movzx edx, byte [gScrCompileGlob+0x2c]
	mov [ebp-0xa5], dl
	mov ecx, [gScrCompileGlob+0x30]
	mov [ebp-0xa4], ecx
	mov byte [gScrCompileGlob+0x2c], 0x0
	movzx ebx, byte [gScrCompileGlob+0x34]
	mov [ebp-0x9d], bl
	mov esi, [gScrCompileGlob+0x38]
	mov [ebp-0x9c], esi
	mov byte [gScrCompileGlob+0x34], 0x0
	mov edx, [ebp+0x14]
	mov [esp], edx
...
EmitForStatement_480:
	...
	mov [gScrCompileGlob+0x2c], bl
	mov esi, [ebp-0xa4]
	mov [gScrCompileGlob+0x30], esi
	movzx eax, byte [ebp-0x9d]
	mov [gScrCompileGlob+0x34], al
	mov edx, [ebp-0x9c]
	mov [gScrCompileGlob+0x38], edx
	cmp byte [ebp-0x95], 0x0
...
_Z19EmitSwitchStatement6sval_uS_S_hjP11scr_block_s:
	...
	mov edx, [gScrCompileGlob+0x28]
	mov [ebp-0x74], edx
	movzx ecx, byte [gScrCompileGlob+0x2c]
	mov [ebp-0x6d], cl
	mov ebx, [gScrCompileGlob+0x30]
	mov [ebp-0x6c], ebx
	mov byte [gScrCompileGlob+0x2c], 0x0
	lea ebx, [ebp-0x28]
	mov ecx, [ebp+0x10]
...
EmitSwitchStatement_590:
	...
	call _Z10TempMalloci
	mov [ebp-0x60], eax
	mov dword [gScrCompileGlob+0x28], 0x0
	mov dword [gScrCompileGlob+0x30], 0x0
	mov edx, esi
	mov [ebp-0x56], dl
	mov ecx, [gScrCompileGlob+0x3c]
	mov [ebp-0x54], ecx
	mov ebx, [gScrCompileGlob+0x40]
	mov [ebp-0x50], ebx
	mov esi, [gScrCompileGlob+0x44]
	mov [ebp-0x4c], esi
	mov dword [ebp-0x1c], 0x0
	mov dword [esp], 0x1000
	call _Z27Hunk_AllocateTempMemoryHighi
	...
	lea eax, [ebp-0x1c]
	mov [gScrCompileGlob+0x40], eax
	mov dword [gScrCompileGlob+0x44], 0x0
	mov eax, [edi]
	mov esi, [eax+0x4]
	test esi, esi
...
EmitSwitchStatement_450:
	...
	mov [ebx+0x4], eax
	mov [ebx+0x8], esi
	mov eax, [gScrCompileGlob+0x28]
	mov [ebx+0xc], eax
	mov [gScrCompileGlob+0x28], ebx
EmitSwitchStatement_140:
	mov byte [ebp-0x55], 0x1
EmitSwitchStatement_480:
	mov edi, [gScrCompileGlob+0x44]
	mov [ebp-0x34], edi
	mov ecx, [ebp+0x10]
	add ecx, 0x18
	mov [ebp-0x30], ecx
...
_Z18EmitThreadInternalj6sval_uS_S_P11scr_block_s:
	...
	mov ecx, [ebp+0xc]
	mov [ebp-0x28], ecx
	mov [gScrCompileGlob+0xc], eax
	mov eax, [ebp-0x20]
	mov [esp], eax
	call _Z23AddThreadStartOpcodePosj
	mov dword [gScrCompileGlob+0x10], 0x0
	mov dword [gScrCompileGlob+0x14], 0x0
	mov dword [gScrCompileGlob+0x18], 0x0
	mov edx, [ebp-0x1c]
	mov ebx, [edx+0x4]
	cmp dword [gScrCompilePub+0x20024], 0x2
...
ScriptCompile_590:
	mov ecx, [ecx+0x4]
	mov [ebp-0x70], ecx
	mov byte [gScrCompileGlob+0x1d], 0x0
	mov eax, [ecx]
	mov edi, [eax+0x4]
	test edi, edi
...
ScriptCompile_90:
	...
	cmp byte [gScrCompileGlob+0x1d], 0x0
	jnz ScriptCompile_140
	mov byte [gScrCompileGlob+0x1d], 0x1
	mov ecx, [ebp-0x58]
	mov eax, [ecx+0x4]
	mov [gScrCompileGlob+0x20], eax
	mov edi, [edi+0x4]
	test edi, edi
	jnz ScriptCompile_90
ScriptCompile_100:
...
ScriptCompile_610:
	mov byte [gScrCompileGlob+0x24], 0x1
	mov byte [gScrCompileGlob+0x25], 0x1
	mov ecx, [ebp-0x70]
	mov eax, [ecx]
	mov eax, [eax+0x4]
	mov [ebp-0x3c], eax
...
ScriptCompile_340:
	...
	lea edx, [ebp-0x30]
	mov eax, ebx
	call _Z10LinkThreadjP13VariableValueb
ScriptCompile_350:
	mov [esp], esi
...
ScriptCompile_490:
	...
	mov byte [gScrCompileGlob+0x34], 0x0
	mov dword [gScrCompileGlob+0x38], 0x0
	mov dword [gScrCompileGlob+0x3c], 0x0
	mov dword [gScrCompileGlob+0x48], 0x0
	cmp byte [gScrCompileGlob+0x25], 0x0
...
ScriptCompile_510:
	...
	mov dword [gScrCompileGlob+0x3c], 0x0
	mov dword [gScrCompileGlob+0x48], 0x0
	cmp byte [gScrCompileGlob+0x24], 0x0
...
ScriptCompile_320:
	...
	jmp ScriptCompile_350
ScriptCompile_530:
	mov byte [gScrCompileGlob+0x25], 0x0
	xor ecx, ecx
	xor edx, edx
	xor eax, eax
	call _Z10EmitOpcodejii
...
ScriptCompile_600:
	mov byte [gScrCompileGlob+0x24], 0x0
	xor ecx, ecx
	xor edx, edx
	xor eax, eax
	call _Z10EmitOpcodejii
