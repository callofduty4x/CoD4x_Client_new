;Imports of phys_ode:
	...
	extern _Z40ODE_CollideSimpleSpaceWithGeomNoAABBTestP7dxSpaceP6dxGeomPv
	...
	extern _Z8ODE_Initv
	extern dWorldCreate
	extern _Z15dGetSimpleSpace9PhysWorld
	extern _Z21dGetContactJointGroup9PhysWorld
...
;Exports of phys_ode:
	...
	global _Z17Phys_NearCallbackPvP6dxGeomS1_
...
_Z29Phys_AdjustForNewCenterOfMassP6dxBodyPKf_40:
	...
	mov [esp+0x4], esi
	mov [esp], ebx
	call _Z26ODE_GeomTransformGetOffsetP6dxGeomPf
	...
	mov [esp+0x4], esi
	mov [esp], ebx
	call _Z26ODE_GeomTransformSetOffsetP6dxGeomPKf
	mov [esp], ebx
	call dGeomGetBodyNext
	mov ebx, eax
	test eax, eax
...
_Z26Phys_DrawDebugTextForWorldjPKcPfS1_fPK15ScreenPlacement:
	...
	mov [esp], eax
	call _Z21ODE_WorldGetBodyCountP7dxWorld
	mov edi, eax
...
_Z21Phys_DoBodyOncePerRunP6dxBody_20:
	...
	mov [esp+0x4], eax
	mov [esp], edx
	call _Z25ODE_GeomGetAAContainedBoxP6dxGeomPfS1_
...
_Z26Phys_BodyAddGeomAndSetMass9PhysWorldP6dxBodyfPK9GeomStatePKf_40:
	...
	mov [esp], eax
	call _Z20dCreateGeomTransformP7dxSpaceP6dxBody
	mov ebx, eax
	test eax, eax
	...
	mov [esp+0x4], eax
	mov [esp], ebx
	call _Z28ODE_GeomTransformSetRotationP6dxGeomPKfS2_
...
;Phys_NearCallback
_Z17Phys_NearCallbackPvP6dxGeomS1_:
	push ebp
	mov ebp, esp
	push edi
	push esi
...
_Z14Phys_RunToTimei9PhysWorldi_110:
	...
	mov [esp], eax
	call _Z40ODE_CollideSimpleSpaceWithGeomNoAABBTestP7dxSpaceP6dxGeomPv
	movss xmm0, dword [ebp-0x2c]
	movss [esp+0x4], xmm0
	mov [esp], ebx
...
_Z14Phys_RunToTimei9PhysWorldi_100:
	mov dword [esp+0x8], _Z17Phys_NearCallbackPvP6dxGeomS1_
	lea eax, [ebp-0x1c]
	mov [esp+0x4], eax
	mov eax, [ebp-0x1c]
...
_Z9Phys_Initv_20:
	...
	mov [esp], esi
	call _Z15dGetSimpleSpace9PhysWorld
	mov [ebx], eax
	mov [esp], esi
	call _Z21dGetContactJointGroup9PhysWorld
	mov [ebx+0xc], eax
	mov dword [esp+0x4], 0x1
	mov eax, [ebx-0x270]
	mov [esp], eax
