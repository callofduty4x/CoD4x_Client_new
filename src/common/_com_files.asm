;Imports of com_files:
	...
	extern qsort
	extern _Z16Sys_FreeFileListPPKc
	extern unzOpen
	...
	extern iGetFileAttributesA
	extern iSetFileAttributesA
	...
	extern _Z19FS_SanitizeFilenamePKcPci
