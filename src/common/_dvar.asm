...
;Exports of dvar:
	...
	global _Z12Dvar_SetBoolPK6dvar_sb
...
_Z15Dvar_SetVariantP6dvar_s9DvarValue13DvarSetSource_220:
	...
	mov eax, [dvar_cheats]
	cmp byte [eax+0xc], 0x0
	jmp _Z15Dvar_SetVariantP6dvar_s9DvarValue13DvarSetSource_330 ;change this back into jnz to regain cheat protection
	mov eax, [edi]
	mov [esp+0x8], eax
...
_Z12Dvar_SetBoolPK6dvar_sb:
	...
	jnz _Z12Dvar_SetBoolPK6dvar_sb_10
	mov [ebp-0x28], al
	mov ebx, [ebp-0x28]
_Z12Dvar_SetBoolPK6dvar_sb_20:
	mov [ebp-0x18], ebx
	mov ecx, [ebp-0x24]
	mov [ebp-0x14], ecx
	mov edx, [ebp-0x20]
...
_Z12Dvar_SetBoolPK6dvar_sb_10:
	...
	mov [ebp-0x28], eax
	mov ebx, eax
	jmp _Z12Dvar_SetBoolPK6dvar_sb_20
	nop
