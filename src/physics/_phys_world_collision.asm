;Imports of phys_world_collision:
	...
	extern g_entities
	extern _Z21ODE_CollideCapsuleBoxPKfS0_PfS0_S0_ffiP12dContactGeom
	extern dGeomBoxGetLengths
	extern _Z14ODE_CreateGeomiP7dxSpaceP6dxBody
	extern dCreateGeomClass
	extern dInfiniteAABB
	extern _Z17Phys_GetWorldGeomv
	extern physGlob
	extern _Z13dInitUserGeomP6dxGeomiP7dxSpaceP6dxBody
...
_Z17dCollideWorldGeomP6dxGeomS0_iP12dContactGeomi_240:
	...
	call _Z21ODE_CollideCapsuleBoxPKfS0_PfS0_S0_ffiP12dContactGeom
	add ebx, eax
	mov [ebp-0x58], ebx
...
_Z20Phys_CreateBrushGeomP7dxSpaceP6dxBodyPK8cbrush_tPKf:
	...
	mov [esp+0x4], eax
	mov dword [esp], 0xc
	call _Z14ODE_CreateGeomiP7dxSpaceP6dxBody
	mov ebx, eax
	test eax, eax
...
_Z23Phys_InitWorldCollisionv:
	...
	mov [esp], eax
	call _Z13dInitUserGeomP6dxGeomiP7dxSpaceP6dxBody
	leave
	ret
