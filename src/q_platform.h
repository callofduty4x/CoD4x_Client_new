...
#define _BigShort(x) ShortSwap(x)
#define _BigLong(x) LongSwap(x)
#define _BigFloat(x) FloatSwap(x)
#define _LittleShort(x) ShortNoSwap(x)
#define _LittleLong(x) LongNoSwap(x)
#define _LittleFloat(x) FloatNoSwap(x)
