...
#include <script/cscr_variable.h>
#include <script/cscr_const.h>
...
struct client_fields_s
{
  ...
  int ofs;
  fieldtype_t type;
  void (*setter)(gclient_s *, struct client_fields_s *);
  void (*getter)(gclient_s *, struct client_fields_s *);
};

void ClientScr_ReadOnly(gclient_s *pSelf, client_fields_s *pField)
{
  assert( pSelf );
  assert( pField );
...
void ClientScr_GetSessionTeam(gclient_s *pSelf, client_fields_s *pField)
{
  assert( pSelf );
...
void ClientScr_SetSessionTeam(gclient_s *pSelf, client_fields_s *pField)
{
  uint16_t newTeam;
...
void ClientScr_SetArchiveTime(gclient_s *pSelf, client_fields_s *pField)
{
    assert( pSelf );
...
void ClientScr_GetArchiveTime(gclient_s *pSelf, client_fields_s *pField)
{
  Scr_AddFloat((float)pSelf->sess.archiveTime * 0.001);
}

void ClientScr_SetMaxHealth(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf);
...
void ClientScr_SetHeadIconTeam(gclient_s *pSelf, client_fields_s *pField)
{
  gentity_s *pEnt;
  uint16_t sTeam;
...
void ClientScr_GetHeadIconTeam(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
  assert( (unsigned int)(pSelf - level.clients) < (unsigned int)level.maxclients);
...
void ClientScr_SetScore(gclient_s *pSelf, client_fields_s *pField)
{
  int score;
...
void ClientScr_SetKillCamEntity(gclient_s *pSelf, client_fields_s *pField)
{
...
void ClientScr_SetSessionState(gclient_s *pSelf, client_fields_s *pField)
{
  uint16_t newState;
  assert(pSelf != NULL);
...
void ClientScr_GetSessionState(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
  assert(pSelf->sess.connected != CON_DISCONNECTED);
...
void ClientScr_GetStatusIcon(gclient_s *pSelf, client_fields_s *pField)
{
...
void ClientScr_SetStatusIcon(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void ClientScr_SetSpectatorClient(gclient_s *pSelf, client_fields_s *pField)
{
...
void ClientScr_GetSpectatorClient(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void ClientScr_SetPSOffsetTime(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void ClientScr_GetPSOffsetTime(gclient_s *pSelf, client_fields_s *pField)
{
  Scr_AddInt(pSelf->sess.archiveTime);
}

void ClientScr_SetHeadIcon(gclient_s *pSelf, client_fields_s *pField)
{
  gentity_s *pEnt;
  const char *pszIcon; 
...
void ClientScr_GetHeadIcon(gclient_s *pSelf, client_fields_s *pField)
{
  char szConfigString[1024];
  gentity_s *pEnt;
...
void ClientScr_GetEntityFromIndex(gclient_s *pSelf, client_fields_s *pField)
{
  int entNum;
  gentity_s* ent;
...
void ClientScr_GetName(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);

  Scr_AddString(CS_DisplayName(&pSelf->sess, 3));
}
/*
void ClientScr_SetName(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void ClientScr_GetBotStatus(gclient_s *pSelf, client_fields_s *pField)
{
	assert(pSelf != NULL);
...
void ClientScr_GetLocalization(gclient_s *pSelf, client_fields_s *pField)
{
	assert(pSelf != NULL);
...
//  { "name", 0, F_LSTRING, &ClientScr_SetName, &ClientScr_GetName },
  { "name", 0, F_LSTRING, NULL, &ClientScr_GetName },
...
void Scr_GetClientField(gclient_s *client, int offset)
{
  ...
  {
    assert(f->ofs);
    Scr_GetGenericField((unsigned char *)client, f->type, f->ofs);
  }
}
...
void Scr_SetClientField(gclient_s *client, int offset)
{
  ...
  {
    assert(f->ofs);
    Scr_SetGenericField((unsigned char *)client, f->type, f->ofs);
  }
}
