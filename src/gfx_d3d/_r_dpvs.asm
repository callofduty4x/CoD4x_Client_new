...
_Z46R_AddCellSurfacesAndCullGroupsInFrustumDelayedPK7GfxCellPK9DpvsPlaneii:
	...
	mov [esp+0x4], eax
	mov dword [esp], 0x3
	call _Z14R_AddWorkerCmd13WorkerCmdTypePv ;WRKCMD_DPVS_CELL_STATIC This cmd draws almost the complete world
	mov eax, rgp
	mov eax, [eax+0x20a0]
	sub ebx, [eax+0x104]
	sar ebx, 0x3
	...
	mov [esp+0x4], ebx
	mov dword [esp], 0x5
	call _Z14R_AddWorkerCmd13WorkerCmdTypePv ;WRKCMD_DPVS_CELL_DYN_MODEL
	mov [esp+0x4], ebx
	mov dword [esp], 0x4
	call _Z14R_AddWorkerCmd13WorkerCmdTypePv ;WRKCMD_DPVS_CELL_SCENE_ENT: models like cars, but not all xmodels
	mov [esp+0x4], ebx
	mov dword [esp], 0x6
	call _Z14R_AddWorkerCmd13WorkerCmdTypePv ;WRKCMD_DPVS_CELL_DYN_BRUSH
	add esp, 0x3c
	pop ebx
	pop esi
	pop edi
