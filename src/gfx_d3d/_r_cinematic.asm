;Imports of r_cinematic:
	...
	extern snprintf
	extern fclose
	extern iBinkSetIOSize
	extern iBinkOSOpen
	extern iBinkGetError
	extern fread
	extern _Z7Sys_Cwdv
	...
	extern iBinkClose
	extern iBinkGetRealtime
	extern iBinkPause
	extern iBinkWait
	extern iBinkControlBackgroundIO
	...
	extern iBinkNextFrame
	extern iBinkSetMemory
	extern iBinkSetSoundTrack
	extern _Z16Com_PrintWarningiPKcz
	extern iBinkGetFrameBuffersInfo
	extern iBinkRegisterFrameBuffers
	extern __udivdi3
	extern _Z25Sys_SuspendDatabaseThread11ThreadOwner
	extern _Z33R_Cinematic_ClearBinkDrawTexturesP14BINKTEXTURESET
	extern iBinkSetMixBinVolumes
	extern iBinkSetVolume
	extern _Z22R_Cinematic_Bink_Allocj
	extern _Z21R_Cinematic_Bink_FreePv
...
_Z23R_Cinematic_UpdateFramev_160:
	...
	mov [esp], eax
	call iBinkSetSoundSystem
	lea eax, [ebp-0x50]
	mov [esp+0x4], eax
	mov dword [esp], 0x5
	call iBinkSetSoundTrack
	mov dword [cinematicGlob+0x30c], 0x0
...
_Z23R_Cinematic_UpdateFramev_450:
	...
	mov eax, [cinematicGlob+0x318]
	mov [esp], eax
	call iBinkRegisterFrameBuffers
...
_Z25R_Cinematic_EndLostDevicev:
	...
	call _Z32R_Cinematic_MakeBinkDrawTexturesv
	lea eax, [cinematicGlob+0x31c]
	mov [esp], eax
	call _Z33R_Cinematic_ClearBinkDrawTexturesP14BINKTEXTURESET
